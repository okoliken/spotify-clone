...
type LayoutRouteId = RouteId | "/" | "/[list=list]/[...rest]" | "/album/[id]" | "/artist/[id]" | "/login" | "/playlist" | "/playlist/[id]" | "/playlist/[id]/edit" | "/playlists" | "/playlists/new" | "/profile" | "/search" | "/search/[query]" | null
type LayoutParams = RouteParams & { list?: string,rest?: string,id?: string,query?: string }
